...
model_name = "lambda-0-distilled-code-llama"
...
def startDistillation():
    ...
    finetuned_tiny_llama_model = AutoModelForCausalLM.from_pretrained("TinyLlama/TinyLlama-1.1B-Chat-v1.0", torch_dtype=torch.bfloat16)
